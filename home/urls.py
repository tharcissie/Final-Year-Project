...
from .views import homepage, article_details, announcement_details,  ArticleLikeToggle, ArticleDislikeToggle, announcement_detail
...
urlpatterns = [
    ...
    path('announcement-detail/<int:pk>/', announcement_detail, name='announcement_detail'),    ### viewing the details of article at the home page
